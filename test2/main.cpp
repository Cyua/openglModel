...
bool init(){
    ...
    modelManager[0].readObj("/Users/frozenshore/coding/cpp/test2/objs/Cow_dABF.obj");
    modelManager[1].readObj("/Users/frozenshore/coding/cpp/test2/objs/grass.obj");
    modelManager[2].readObj("/Users/frozenshore/coding/cpp/test2/objs/city.obj");
    modelManager[3].readObj("/Users/frozenshore/coding/cpp/test2/objs/monster.obj");
    
    BmpReader bmpManager;
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/floor.bmp");
    ...
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/cow.bmp");
    glBindTexture (GL_TEXTURE_2D, textureObjects[1]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
    ...
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/grass.bmp");
    glBindTexture (GL_TEXTURE_2D, textureObjects[2]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
    ...
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/city.bmp");
    glBindTexture (GL_TEXTURE_2D, textureObjects[3]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
    ...
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/chosen.bmp");
    glBindTexture (GL_TEXTURE_2D, textureObjects[4]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
    ...
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/right.bmp");
    glBindTexture (GL_TEXTURE_2D, backgroundTexture[0]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
    ...
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/front.bmp");
    glBindTexture (GL_TEXTURE_2D, backgroundTexture[1]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
                  ...
                  bmpManager.imgdata);
    bmpManager.clear();
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/left.bmp");
    glBindTexture (GL_TEXTURE_2D, backgroundTexture[2]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
                  ...
                  bmpManager.imgdata);
    bmpManager.clear();
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/back.bmp");
    glBindTexture (GL_TEXTURE_2D, backgroundTexture[3]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
                  ...
                  bmpManager.imgdata);
    bmpManager.clear();
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/up.bmp");
    glBindTexture (GL_TEXTURE_2D, backgroundTexture[4]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
                  ...
                  bmpManager.imgdata);
    bmpManager.clear();
    bmpManager.readBMP("/Users/frozenshore/coding/cpp/test2/textures/down.bmp");
    glBindTexture (GL_TEXTURE_2D, backgroundTexture[5]);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
    glTexParameteri (GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
    glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB, bmpManager.w,
